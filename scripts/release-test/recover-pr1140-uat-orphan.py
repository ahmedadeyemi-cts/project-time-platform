#!/usr/bin/env python3
"""Recover only PR 1140's observed zero-job Test dispatch.
...
OLD_SHA = "4e8871cf9a7c4643483d178feecff67ec6d78d12"
...
if __name__ == "__main__":
    try:
        print("PR1140_UAT_ORPHAN_RECOVERY=" +
