...
expected=['103_module_066_flowhive_enterprise_psa_revamp.sql','104_flowhive_bounded_ai_execution.sql','105_flowhive_reviewed_regeneration.sql','106_module025_sow_sell_register.sql']
...
export MAIN_RELEASE_MIGRATION_SCOPE=flowhive-enterprise-psa-103-106-test
