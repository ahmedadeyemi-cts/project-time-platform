...
| Unified editable WBS, Kanban, timeline, Gantt and monthly calendar | `ProjectFlowHivePsaWorkspace.jsx`, `ProjectFlowHiveCenter.jsx`, `project-forge/ProjectForgeViews.jsx`, `project-flowhive-planner-layout.css`, `ProjectFlowHivePsaArtifactRenderer.cs` | Planner browser/layout checks and full page browser suite passed; PR884 FlowHive CI run `34277993696` passed exact head `a7b8127ff35a56d8d794fad3b6f9e10f77d6b3bf`; synthetic Gantt and monthly-calendar PDFs were rendered and visually inspected from the uploaded evidence artifact | None; PR884 candidate `a7b8127ff35a56d8d794fad3b6f9e10f77d6b3bf` is not deployed | Not run; CI fixtures are not live UAT | Prove one authoritative editable task graph across all views, including persistence, accessibility, concurrent edits and live schedule behavior |
...
| Six US Signal-branded XLSX/PDF exports | `ProjectFlowHivePsaArtifactRenderer.cs`, `ProjectFlowHiveArtifactRenderer.cs`, `AnalyticsBrandedExportBuilder.cs`, `Module025SowGsdDocumentExporter.cs` | PR883 run `34276704342` passed exact head `f7f03e3fb263e1ce26e8401c4ae811a9f80fb174` with Unicode PDF extraction/rendering and lossless typed XLSX checks for all six kinds; PR884 run `34277993696` passed exact head `a7b8127ff35a56d8d794fad3b6f9e10f77d6b3bf` with graphical Gantt/calendar checks; uploaded evidence contains twelve synthetic XLSX/PDF artifacts, extracted text and twelve rendered PNG pages, with representative pages visually inspected | None; PR884 candidate `a7b8127ff35a56d8d794fad3b6f9e10f77d6b3bf` is not deployed | Not run; synthetic artifacts are not live customer/internal delivery evidence | Complete deployed UAT export review for all twelve artifacts, including authorized downloads, typed data/formula safety, pagination, branding, graphical layouts and redaction |
