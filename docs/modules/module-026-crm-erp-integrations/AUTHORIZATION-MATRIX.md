...
| Use configured ConnectWise SELL connection in Module 055D | No | Yes | No | No |
...
The Project Team Coordinator can consume the configured ConnectWise SELL connection only
