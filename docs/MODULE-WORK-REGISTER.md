...
| 055C Manage Existing Projects | Deployed split; assigned-PM edit scope and selected-project Module 040 closeout handoff are being corrected | Guarded authorization/handoff PR pending | Migrations 034/035 applied in test; migration 036 pending | Validate source and CI; migration and deployment remain separate actions |
| 055D Create New Project | Deployed GSD/SELL creation; PTC, Administrator, and Super Administrator exposure is being corrected | Guarded authorization/handoff PR pending | Migrations 034/035 applied in test; migration 036 pending | Validate source and CI; provider configuration, migration, and deployment remain separate actions |
...
| 055C | Assigned PM edits assigned projects; PTC/Admin/Super Admin edit all; durable mutation evidence and Module 040 handoff | Authorization/handoff correction in progress | Migration 036 not applied; no deployment action performed | Require green CI/review before merge; migration/deployment require separate authorization |
| 055D | PTC/Admin/Super Admin Create New Project with GSD/SELL source selection and SELL field locks | Authorization/handoff correction in progress | Migration 036 not applied; no SELL call or deployment action performed | Require green CI/review before merge; migration/deployment require separate authorization |
