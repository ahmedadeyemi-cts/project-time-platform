...
export function verifyFiles(changed, manifest, mode = 'initial', context = null) {
  ...
  const effectiveScopedExpected = mode === 'planner-live-repair-candidate-refresh' ? plannerLiveRepairCandidateRefreshFiles : scopedExpected;
...
export function validate() {
  ...
  if (!isPlannerLiveRepairCandidateRefresh) verifyFiles(changed, manifest,
