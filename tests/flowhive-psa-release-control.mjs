...
export const plannerCelarApprovalRefreshBase = 'f7ee256fb851cbdeb083c2ff6fe8ad650ee4d203';
export const plannerCelarApprovalRefreshBranch = 'control/flowhive-planner-celar-approval-20260915';
export const plannerCelarApprovalRefreshFiles = [
  '.github/flowhive-psa-protected-cutover.json',
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/module025-governed-protected-test-release-manual.yml',
...
export const module025CandidateRefreshBase = '6bad29fab087f62337bb1515a53e319941bcf190';
export const module025CandidateRefreshBranch = 'control/flowhive-module025-candidate-refresh-20260916';
export const module025CandidateRefreshFiles = [
  '.github/flowhive-psa-protected-cutover.json',
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/module025-governed-protected-test-release-manual.yml',
...
export const module025AdmissionManifestRefreshBase = '557e32aaf2c6be34557990becc6d3dea092efc3a';
export const module025AdmissionManifestRefreshBranch = 'control/flowhive-admission-manifest-refresh-20260916';
export const module025AdmissionManifestRefreshFiles = [
  '.github/flowhive-psa-release-control-files.txt',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/module025-governed-protected-test-release-manual.yml',
  'scripts/release-test/validate-protected-test-controller-branches.sh',
...
export const plannerCandidateDispatchEvidenceFiles = [
  '.github/flowhive-psa-protected-test-candidate.json',
  'scripts/release-test/flowhive-psa-admission.mjs',
  'scripts/release-test/validate-protected-test-controller-branches.sh',
  'tests/flowhive-psa-admission.test.mjs',
...
export const plannerCandidateSourceDriftBoundaryBase = 'e70a3bd5ede89f935cd9274010542eda8099162c';
...
export const plannerParallelPhaseCandidateRefreshBase = '4bb7ae0b2411eb9120db82b9268737080908105c';
export const plannerParallelPhaseCandidateRefreshBranch = 'control/flowhive-planner-parallel-phase-candidate-refresh-20260915';
export const plannerParallelPhaseCandidateRefreshFiles = [
  '.github/flowhive-psa-protected-cutover.json',
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/projectpulse-release-test-control-ci.yml',
...
export const plannerRuntimeCheckOmissionBase = 'f9807c8148a54ee4229a565dd2e4c754d8392fcf';
export const plannerRuntimeCheckOmissionBranch = 'control/flowhive-planner-runtime-check-omission-20260915';
export const plannerRuntimeCheckOmissionFiles = [
  '.github/flowhive-psa-protected-test-candidate.json',
  'scripts/release-test/flowhive-psa-admission.mjs',
  'tests/flowhive-psa-admission.test.mjs',
  'tests/flowhive-psa-release-control.mjs'
].sort();
export const plannerCelarRequiredCheckRefreshBase = 'b933aa61ff6e006e40a3a4a124f50b7f01a1a2c3';
export const plannerCelarRequiredCheckRefreshBranch = 'control/flowhive-planner-celar-required-check-refresh-20260915';
export const plannerCelarRequiredCheckRefreshFiles = [
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  'scripts/release-test/flowhive-psa-admission.mjs',
  'tests/flowhive-psa-admission.test.mjs',
...
export const dispatchValidationBase = '8c68e03e191bdedfa13b1e24d4b5141b1fd891f1';
export const dispatchValidationBranch = 'control/flowhive-dispatch-validation-20260916';
export const dispatchValidationFiles = [
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  'tests/flowhive-psa-admission.test.mjs',
  'tests/flowhive-psa-release-control.mjs',
  'tests/flowhive-psa-release-workflow.test.py'
].sort();
export const dispatchValidationFollowupBase = 'b9dac833a28fa37cd86f78067990becb82ed3534';
...
export const plannerParallelPhaseFixBase = 'e3ddf7a3b8807a98becfa36be949e20c97f1c4a3';
...
export const plannerLiveCompletionRepairBase = '038c658a45a7f1fa3b1aa695b0bed554fdf1f1aa';
export const plannerLiveCompletionRepairBranch = 'fix/flowhive-planner-live-completion-20260915';
export const plannerLiveCompletionRepairFiles = [
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/projectpulse-release-test-control-ci.yml',
  'src/backend/ProjectTime.Api/Ai/PulseAiPrivateRagService.cs',
  'tests/FlowHiveDetailedPlannerTests/Program.cs',
...
export const plannerCapacitySafeCandidateRefreshBase = '45c4fa52ca33c7c60876c08fb800b6f938cb6ddd';
export const plannerCapacitySafeCandidateRefreshBranch = 'control/flowhive-planner-capacity-safe-candidate-refresh-20260915';
export const plannerCapacitySafeCandidateRefreshFiles = [
  '.github/flowhive-psa-protected-cutover.json',
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/projectpulse-release-test-control-ci.yml',
...
export const plannerLiveCapacityCandidateRefreshBase = '1d11b029ca7c63551af71a098b7a7f4618ce290b';
export const plannerLiveCapacityCandidateRefreshBranch = 'control/flowhive-planner-live-capacity-candidate-refresh-20260915';
export const plannerLiveCapacityCandidateRefreshFiles = [
  '.github/flowhive-psa-protected-cutover.json',
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/projectpulse-release-test-control-ci.yml',
...
export const portfolioDbAliasCandidateRefreshBase = 'd6539ae1bf02f5b7a3d5d6386cac827ec63dd785';
export const portfolioDbAliasCandidateRefreshBranch = 'control/flowhive-portfolio-db-alias-candidate-refresh-20260915';
export const portfolioDbAliasCandidateRefreshFiles = [
  '.github/flowhive-psa-protected-cutover.json',
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  'docs/releases/FLOWHIVE-PSA-PROTECTED-TEST-ADMISSION.md',
...
export const plannerCandidateRefreshBase = '4b4e0bbec528ebacbc2bc272ada3e3ea21831952';
export const plannerCandidateRefreshBranch = 'control/flowhive-planner-live-completion-candidate-refresh-20260915';
export const plannerCandidateRefreshFiles = [
  '.github/flowhive-psa-protected-cutover.json',
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  '.github/workflows/projectpulse-release-test-control-ci.yml',
...
export const plannerAdmissionEvidenceCorrectionBase = 'dd50737e751cf2de8d067ab7770c233f51200064';
export const plannerAdmissionEvidenceCorrectionBranch = 'control/flowhive-planner-live-completion-admission-evidence-20260915';
export const plannerAdmissionEvidenceCorrectionFiles = [
  '.github/flowhive-psa-protected-test-candidate.json',
  '.github/workflows/projectpulse-release-test-control-ci.yml',
  'scripts/release-test/flowhive-psa-admission.mjs',
  'tests/flowhive-psa-admission.test.mjs',
...
export function verifyFiles(changed, manifest, mode = 'initial', context = null) {
  ...
  assert.ok(['initial','pr874-digest-repair','reviewed-regeneration-105','candidate-refresh','successor-candidate-refresh','source-base-correction','successor-approval','successor-release-approval','successor-cutover-activation','planner-output-budget-approval','planner-output-shape-approval','planner-output-shape-activation','planner-output-shape-branch-correction','planner-phase-candidate-refresh','live-planner-candidate-refresh','planner-latency-candidate-refresh','planner-context-budget-candidate-refresh','planner-single-batch-candidate-refresh','planner-compact-batch-candidate-refresh','planner-compact-phase-native-gate','planner-parallel-phase-candidate-refresh','planner-runtime-check-omission','planner-compact-batch-activation','planner-compact-batch-admission-ancestry-fix','planner-compact-batch-source-drift-boundary','planner-compact-batch-activation-renewal','planner-live-repair-candidate-refresh','planner-live-repair-final-refresh','planner-provider-contract-refresh','planner-live-provider-output-refresh','planner-native-test-approval-renewal','planner-single-batch-activation','planner-context-budget-activation','planner-latency-activation','live-planner-activation','planner-time-budget-approval','planner-provider-budget-successor-approval','planner-provider-budget-activation','planner-time-budget-workflow-set','planner-time-budget-activation','planner-output-budget-activation','planner-output-budget-activation-refresh','planner-output-budget-candidate-refresh','planner-output-budget-final-activation','planner-provider-deadline-retry','planner-provider-deadline-candidate-refresh','planner-compact-phase-fix','planner-parallel-phase-fix','planner-compact-phase-candidate-refresh','planner-control-candidate-approval','planner-control-candidate-base-correction','planner-control-path-coverage','planner-candidate-approval-refresh','planner-celar-approval-refresh','planner-live-celar-budget-approval','module025-candidate-refresh','module025-admission-manifest-refresh','planner-celar-required-check-refresh','planner-candidate-dispatch-evidence','planner-candidate-source-drift-boundary','planner-admission-manifest-refresh','planner-admission-evidence-correction','dispatch-run-recovery','dispatch-lane-repair','dispatch-skipped-recovery','dispatch-receipt-parser','dispatch-lane-admission','dispatch-validation','dispatch-validation-followup','stale-run-supersession','stale-run-activation','stale-run-renewal','migration106-wiring','release-stabilization','protected-cutover','protected-cutover-activation','protected-cutover-refresh','protected-cutover-lane-refresh','protected-cutover-pm-identity-refresh','admission-permission-fix','admission-bot-claim-fix','protected-cutover-recovery','reservation-recovery-endpoint-fix','protected-cutover-final','live-uat-status-fix','installed-verification-environment','installed-verification-evidence','installed-acceptance-evidence','installed-acceptance-artifacts','installed-acceptance-readiness','installed-acceptance-visibility','installed-acceptance-planner','installed-acceptance-final','installed-sow-role-acceptance','installed-verifier-main-path','installed-verifier-step-names','module025-my-role-celar-repair','module025-sow-role-candidate-refresh','module025-sow-role-candidate-refresh-final','module025-sow-role-candidate-refresh-1009','module025-sow-role-candidate-refresh-1014','module025-sow-role-admission-scope','module025-sow-role-native-activation','module025-sow-role-native-active','module025-sow-role-live-acceptance','module025-sow-role-live-repair','trigger-coverage','admission-manifest-order','planner-capacity-safe','planner-live-capacity-repair','planner-capacity-safe-candidate-refresh','planner-live-capacity-candidate-refresh','planner-live-completion-repair','planner-candidate-refresh'].includes(mode), 'Unrecognized control repair.');
  ...
  if (mode === 'dispatch-validation') {
    assert.equal(context?.base, dispatchValidationBase, 'Dispatch validation must be based on current trusted main.');
    assert.equal(context?.branch, dispatchValidationBranch, 'Wrong dispatch validation control branch.');
  }
  if (mode === 'dispatch-validation-followup') {
    assert.equal(context?.base, dispatchValidationFollowupBase, 'Dispatch validation follow-up must be based on merged trusted main.');
    assert.equal(context?.branch, dispatchValidationFollowupBranch, 'Wrong dispatch validation follow-up control branch.');
  }
  ...
  if (mode === 'planner-celar-approval-refresh') {
    assert.equal(context?.base, plannerCelarApprovalRefreshBase, 'Celar planner approval refresh must be based on the merged application main.');
    assert.equal(context?.branch, plannerCelarApprovalRefreshBranch, 'Wrong Celar planner approval refresh branch.');
  }
  if (mode === 'planner-live-celar-budget-approval') {
    assert.equal(context?.base, plannerLiveCelarBudgetApprovalBase, 'Live Celar budget approval refresh must be based on the merged application main.');
    assert.equal(context?.branch, plannerLiveCelarBudgetApprovalBranch, 'Wrong live Celar budget approval refresh branch.');
  }
  if (mode === 'module025-candidate-refresh') {
    assert.equal(context?.base, module025CandidateRefreshBase, 'Module025 candidate refresh must be based on the merged manual-validation registration.');
    assert.equal(context?.branch, module025CandidateRefreshBranch, 'Wrong Module025 candidate refresh branch.');
  }
  if (mode === 'module025-admission-manifest-refresh') {
    assert.equal(context?.base, module025AdmissionManifestRefreshBase, 'Module025 admission manifest refresh must be based on the reviewed candidate approval main.');
    assert.equal(context?.branch, module025AdmissionManifestRefreshBranch, 'Wrong Module025 admission manifest refresh branch.');
  }
  if (mode === 'planner-live-celar-budget-approval') {
    assert.equal(context?.base, plannerLiveCelarBudgetApprovalBase, 'Live Celar budget approval refresh must be based on the merged application main.');
    assert.equal(context?.branch, plannerLiveCelarBudgetApprovalBranch, 'Wrong live Celar budget approval refresh branch.');
  }
  if (mode === 'planner-celar-required-check-refresh') {
    assert.equal(context?.base, plannerCelarRequiredCheckRefreshBase, 'Celar required-check refresh must be based on trusted main after PR1049.');
    assert.equal(context?.branch, plannerCelarRequiredCheckRefreshBranch, 'Wrong Celar required-check refresh branch.');
  }
  if (mode === 'planner-candidate-dispatch-evidence') {
    assert.equal(context?.base, plannerCandidateDispatchEvidenceBase, 'Planner candidate dispatch evidence must be based on merged PR1045 main.');
    assert.equal(context?.branch, plannerCandidateDispatchEvidenceBranch, 'Wrong planner candidate dispatch evidence branch.');
  }
  if (mode === 'planner-candidate-source-drift-boundary') {
    assert.equal(context?.base, plannerCandidateSourceDriftBoundaryBase, 'Planner candidate source-drift boundary must be based on merged PR1046 main.');
    assert.equal(context?.branch, plannerCandidateSourceDriftBoundaryBranch, 'Wrong planner candidate source-drift boundary branch.');
  }
  ...
  if (mode === 'planner-admission-evidence-correction') {
    assert.equal(context?.base, plannerAdmissionEvidenceCorrectionBase, 'Planner admission evidence correction must be based on merged PR1042 main.');
    assert.equal(context?.branch, plannerAdmissionEvidenceCorrectionBranch, 'Wrong planner admission evidence correction branch.');
  }
  ...
  if (mode === 'planner-parallel-phase-candidate-refresh') {
    assert.equal(context?.base, plannerParallelPhaseCandidateRefreshBase, 'Planner parallel-phase candidate refresh must be based on the merged application main.');
    assert.equal(context?.branch, plannerParallelPhaseCandidateRefreshBranch, 'Wrong planner parallel-phase candidate refresh branch.');
  }
  ...
  if (mode === 'planner-parallel-phase-fix') {
    assert.equal(context?.base, plannerParallelPhaseFixBase, 'Planner parallel phase fix must be based on current trusted main.');
    assert.equal(context?.branch, plannerParallelPhaseFixBranch, 'Wrong planner parallel phase fix branch.');
  }
  if (mode === 'planner-capacity-safe') {
    assert.equal(context?.base, plannerCapacitySafeBase, 'Planner capacity-safe fix must be based on current trusted main.');
    assert.equal(context?.branch, plannerCapacitySafeBranch, 'Wrong planner capacity-safe fix branch.');
  }
  if (mode === 'planner-live-capacity-repair') {
    assert.equal(context?.base, plannerLiveCapacityRepairBase, 'Live planner capacity repair must be based on the deployed candidate main.');
    assert.equal(context?.branch, plannerLiveCapacityRepairBranch, 'Wrong live planner capacity repair branch.');
  }
  if (mode === 'planner-live-completion-repair') {
    assert.equal(context?.base, plannerLiveCompletionRepairBase, 'Live planner completion repair must be based on the current trusted main.');
    assert.equal(context?.branch, plannerLiveCompletionRepairBranch, 'Wrong live planner completion repair branch.');
  }
  if (mode === 'planner-candidate-refresh') {
    assert.equal(context?.base, plannerCandidateRefreshBase, 'Planner candidate refresh must be based on the merged planner repair main.');
    assert.equal(context?.branch, plannerCandidateRefreshBranch, 'Wrong planner candidate refresh branch.');
  }
  if (mode === 'planner-capacity-safe-candidate-refresh') {
    assert.equal(context?.base, plannerCapacitySafeCandidateRefreshBase, 'Planner capacity-safe candidate refresh must be based on current trusted main.');
    assert.equal(context?.branch, plannerCapacitySafeCandidateRefreshBranch, 'Wrong planner capacity-safe candidate refresh branch.');
  }
  if (mode === 'planner-live-capacity-candidate-refresh') {
    if (context?.branch === portfolioDbAliasCandidateRefreshBranch) {
      assert.equal(context?.base, portfolioDbAliasCandidateRefreshBase, 'Portfolio DB-alias candidate refresh must be based on trusted main after PR1039.');
    } else {
      assert.equal(context?.base, plannerLiveCapacityCandidateRefreshBase, 'Live-capacity candidate refresh must be based on the merged repair main.');
      assert.equal(context?.branch, plannerLiveCapacityCandidateRefreshBranch, 'Wrong live-capacity candidate refresh branch.');
    }
  }
  if (mode === 'planner-compact-phase-fix') {
    assert.equal(context?.base, plannerCompactPhaseFixBase, 'Planner compact phase fix must be based on current trusted main.');
  ...
  if (mode === 'planner-admission-evidence-correction') {
    assert.deepEqual([...changed].sort(), plannerAdmissionEvidenceCorrectionFiles,
      'Planner admission evidence correction contains an unreviewed file.');
    return;
  }
  ...
  const effectiveScopedExpected = mode === 'trigger-coverage' ? triggerCoverageFiles : mode === 'dispatch-validation' ? dispatchValidationFiles : mode === 'dispatch-validation-followup' ? dispatchValidationFollowupFiles : mode === 'planner-provider-deadline-retry' ? plannerProviderDeadlineRetryFiles : mode === 'planner-compact-phase-fix' ? plannerCompactPhaseFixFiles : mode === 'planner-parallel-phase-fix' ? plannerParallelPhaseFixFiles : mode === 'planner-capacity-safe' ? plannerCapacitySafeFiles : mode === 'planner-live-capacity-repair' ? plannerLiveCapacityRepairFiles : mode === 'planner-live-completion-repair' ? plannerLiveCompletionRepairFiles : mode === 'planner-candidate-refresh' ? plannerCandidateRefreshFiles : mode === 'planner-capacity-safe-candidate-refresh' ? plannerCapacitySafeCandidateRefreshFiles : mode === 'planner-live-capacity-candidate-refresh' ? plannerLiveCapacityCandidateRefreshFiles : mode === 'planner-provider-deadline-candidate-refresh' ? plannerProviderDeadlineCandidateRefreshFiles : mode === 'planner-control-candidate-approval' ? plannerControlCandidateApprovalFiles : mode === 'planner-control-path-coverage' ? plannerControlPathCoverageFiles : mode === 'planner-candidate-approval-refresh' ? plannerCandidateApprovalRefreshFiles : mode === 'planner-celar-approval-refresh' ? plannerCelarApprovalRefreshFiles : mode === 'planner-live-celar-budget-approval' ? plannerLiveCelarBudgetApprovalFiles : mode === 'module025-candidate-refresh' ? module025CandidateRefreshFiles : mode === 'planner-celar-required-check-refresh' ? plannerCelarRequiredCheckRefreshFiles : mode === 'planner-candidate-dispatch-evidence' ? plannerCandidateDispatchEvidenceFiles : mode === 'planner-candidate-source-drift-boundary' ? plannerCandidateSourceDriftBoundaryFiles : mode === 'planner-admission-manifest-refresh' ? plannerAdmissionManifestRefreshFiles : mode === 'planner-compact-phase-candidate-refresh' ? plannerCompactPhaseCandidateRefreshFiles : mode === 'planner-compact-phase-native-gate' ? plannerCompactPhaseNativeGateFiles : mode === 'planner-parallel-phase-candidate-refresh' ? plannerParallelPhaseCandidateRefreshFiles : mode === 'planner-runtime-check-omission' ? plannerRuntimeCheckOmissionFiles : mode === 'planner-control-candidate-base-correction' ? plannerControlCandidateBaseCorrectionFiles : mode === 'planner-native-test-approval-renewal' ? plannerNativeTestApprovalRenewalFiles : mode === 'planner-live-repair-candidate-refresh' ? plannerLiveRepairCandidateRefreshFiles : mode === 'planner-live-repair-final-refresh' ? plannerLiveRepairFinalRefreshFiles : mode === 'planner-provider-contract-refresh' ? plannerProviderContractRefreshFiles : mode === 'planner-live-provider-output-refresh' ? plannerLiveProviderOutputRefreshFiles : mode === 'installed-verifier-main-path' ? installedVerifierMainPathFiles : mode === 'installed-verifier-step-names' ? installedVerifierStepNamesFiles : mode === 'module025-sow-role-candidate-refresh' ? module025SowRoleCandidateRefreshFiles : mode === 'module025-sow-role-candidate-refresh-final' ? module025SowRoleCandidateRefreshFinalFiles : mode === 'module025-sow-role-candidate-refresh-1009' ? module025SowRoleCandidateRefresh1009Files : mode === 'module025-sow-role-candidate-refresh-1014' ? module025SowRoleCandidateRefresh1014Files : mode === 'module025-sow-role-admission-scope' ? module025SowRoleAdmissionScopeFiles : mode === 'module025-sow-role-native-activation' ? module025SowRoleNativeActivationFiles : mode === 'module025-sow-role-native-active' ? module025SowRoleNativeActiveFiles : mode === 'module025-sow-role-live-acceptance' ? module025SowRoleLiveAcceptanceFiles : mode === 'module025-sow-role-live-repair' ? module025SowRoleLiveRepairFiles : mode === 'admission-manifest-order' ? admissionManifestOrderFiles : scopedExpected;
  const modeScopedExpected = mode === 'module025-admission-manifest-refresh' ? module025AdmissionManifestRefreshFiles : null;
  const expectedFiles = context?.branch === portfolioDbAliasCandidateRefreshBranch
    ? portfolioDbAliasCandidateRefreshFiles
    : context?.branch === plannerCandidateRefreshBranch
      ? plannerCandidateRefreshFiles
    : modeScopedExpected || effectiveScopedExpected;
  assert.deepEqual([...changed].sort(), expectedFiles, 'Unexpected or missing file in the release-control PR.');
}
...
export function validate() {
  ...
  const isPlannerCelarApprovalRefresh = process.env.GITHUB_HEAD_REF === plannerCelarApprovalRefreshBranch;
  const isPlannerLiveCelarBudgetApproval = process.env.GITHUB_HEAD_REF === plannerLiveCelarBudgetApprovalBranch;
  const isModule025CandidateRefresh = process.env.GITHUB_HEAD_REF === module025CandidateRefreshBranch
    || process.env.GITHUB_HEAD_REF === module025AdmissionManifestRefreshBranch;
  const isModule025AdmissionManifestRefresh = process.env.GITHUB_HEAD_REF === module025AdmissionManifestRefreshBranch;
  const isPlannerCelarRequiredCheckRefresh = process.env.GITHUB_HEAD_REF === plannerCelarRequiredCheckRefreshBranch;
  const isPlannerCandidateDispatchEvidence = process.env.GITHUB_HEAD_REF === plannerCandidateDispatchEvidenceBranch;
  const isPlannerCandidateSourceDriftBoundary = process.env.GITHUB_HEAD_REF === plannerCandidateSourceDriftBoundaryBranch;
  const isPlannerAdmissionManifestRefresh = process.env.GITHUB_HEAD_REF === plannerAdmissionManifestRefreshBranch;
  const isPlannerAdmissionEvidenceCorrection = process.env.GITHUB_HEAD_REF === plannerAdmissionEvidenceCorrectionBranch;
  ...
  const isPlannerParallelPhaseCandidateRefresh = process.env.GITHUB_HEAD_REF === plannerParallelPhaseCandidateRefreshBranch;
  const isPlannerCapacitySafeCandidateRefresh = process.env.GITHUB_HEAD_REF === plannerCapacitySafeCandidateRefreshBranch;
  const isPlannerLiveCapacityCandidateRefresh = process.env.GITHUB_HEAD_REF === plannerLiveCapacityCandidateRefreshBranch
    || process.env.GITHUB_HEAD_REF === portfolioDbAliasCandidateRefreshBranch;
  const isPlannerRuntimeCheckOmission = process.env.GITHUB_HEAD_REF === plannerRuntimeCheckOmissionBranch;
  ...
  // Backward-compatible aliases retained for the long-standing default scope
  // guard below; the canonical names above remain the source of truth.
  const isPlannerSowRoleNativeActive = isModule025SowRoleNativeActive || isPlannerLiveCapacityCandidateRefresh;
  const isPlannerSowRoleLiveAcceptance = isModule025SowRoleLiveAcceptance;
  const isPlannerSowRoleLiveRepair = isModule025SowRoleLiveRepair;
  const isTriggerCoverage = process.env.GITHUB_HEAD_REF === triggerCoverageBranch;
  const isDispatchValidation = process.env.GITHUB_HEAD_REF === dispatchValidationBranch;
  const isDispatchValidationFollowup = process.env.GITHUB_HEAD_REF === dispatchValidationFollowupBranch;
  ...
  const isPlannerParallelPhaseFix = process.env.GITHUB_HEAD_REF === plannerParallelPhaseFixBranch;
  const isPlannerCapacitySafe = process.env.GITHUB_HEAD_REF === plannerCapacitySafeBranch;
  const isPlannerLiveCapacityRepair = process.env.GITHUB_HEAD_REF === plannerLiveCapacityRepairBranch;
  const isPlannerLiveCompletionRepair = process.env.GITHUB_HEAD_REF === plannerLiveCompletionRepairBranch;
  const isPlannerCandidateRefresh = process.env.GITHUB_HEAD_REF === plannerCandidateRefreshBranch;
  ...
  if (isPlannerCelarApprovalRefresh) verifyFiles(changed, manifest, 'planner-celar-approval-refresh', context);
  if (isPlannerLiveCelarBudgetApproval) verifyFiles(changed, manifest, 'planner-live-celar-budget-approval', context);
  if (isModule025CandidateRefresh && !isModule025AdmissionManifestRefresh) verifyFiles(changed, manifest, 'module025-candidate-refresh', context);
  if (isModule025AdmissionManifestRefresh) verifyFiles(changed, manifest, 'module025-admission-manifest-refresh', context);
  if (isPlannerCelarRequiredCheckRefresh) verifyFiles(changed, manifest, 'planner-celar-required-check-refresh', context);
  if (isPlannerCandidateDispatchEvidence) verifyFiles(changed, manifest, 'planner-candidate-dispatch-evidence', context);
  if (isPlannerCandidateSourceDriftBoundary) verifyFiles(changed, manifest, 'planner-candidate-source-drift-boundary', context);
  if (isPlannerAdmissionManifestRefresh) verifyFiles(changed, manifest, 'planner-admission-manifest-refresh', context);
  if (isPlannerAdmissionEvidenceCorrection) verifyFiles(changed, manifest, 'planner-admission-evidence-correction', context);
  ...
  if (isPlannerParallelPhaseCandidateRefresh) verifyFiles(changed, manifest, 'planner-parallel-phase-candidate-refresh', context);
  if (isPlannerCapacitySafeCandidateRefresh) verifyFiles(changed, manifest, 'planner-capacity-safe-candidate-refresh', context);
  if (isPlannerLiveCapacityCandidateRefresh) verifyFiles(changed, manifest, 'planner-live-capacity-candidate-refresh', context);
  if (isPlannerRuntimeCheckOmission) verifyFiles(changed, manifest, 'planner-runtime-check-omission', context);
  ...
  if (isDispatchValidation) verifyFiles(changed, manifest, 'dispatch-validation', context);
  if (isDispatchValidationFollowup) verifyFiles(changed, manifest, 'dispatch-validation-followup', context);
  ...
  if (isPlannerParallelPhaseFix) verifyFiles(changed, manifest, 'planner-parallel-phase-fix', context);
  if (isPlannerCapacitySafe) verifyFiles(changed, manifest, 'planner-capacity-safe', context);
  if (isPlannerLiveCapacityRepair) verifyFiles(changed, manifest, 'planner-live-capacity-repair', context);
  if (isPlannerLiveCompletionRepair) verifyFiles(changed, manifest, 'planner-live-completion-repair', context);
  if (isPlannerCandidateRefresh) verifyFiles(changed, manifest, 'planner-candidate-refresh', context);
  ...
  if (isPlannerLiveCapacityCandidateRefresh) {
    assert.equal(protectedCutover.enabled, true, 'The refreshed candidate must retain the native Test cutover without activating it.');
    assert.equal(protectedCutover.activationDecision, 'native-test-required');
    assert.equal(protectedCutover.workflow.allowControllerActivation, false);
    assert.deepEqual(protectedCutover.approval, {
      mode: 'native-test-environment', status: 'native-required', approvedBy: null, approvedAt: null, expiresAt: null
  ...
  assert.match(module025Workflow, /- '\.github\/workflows\/module025-governed-protected-test-release-manual\.yml'/);
