...
export const installedSowRoleAcceptanceBase = 'be8f883c452bb190cf43ced3142df03e079879dc';
...
export function validate() {
  ...
  if (!isPlannerNativeTestApprovalRenewal && !isPlannerLiveRepairCandidateRefresh && !isPlannerLiveRepairFinalRefresh && !isPlannerProviderContractRefresh && !isPlannerLiveProviderOutputRefresh) verifyFiles(changed, manifest,
