...
export const plannerPhaseCandidateRefreshBase = 'f8cf17a022b008f7fee81f7f2226e774c3056e69';
export const plannerPhaseCandidateRefreshBranch = 'control/flowhive-planner-phase-candidate-refresh-20260912';
...
export function validate() {
  ...
  if (isProtectedCutover || isProtectedCutoverActivation || isProtectedCutoverRefresh || isProtectedCutoverRecovery || isProtectedCutoverFinal || isSuccessorReleaseApproval || isSuccessorCutoverActivation || isPlannerOutputShapeApproval || isPlannerOutputShapeActivation || isPlannerOutputShapeBranchCorrection || isPlannerPhaseCandidateRefresh || isPlannerTimeBudgetApproval || isPlannerProviderBudgetSuccessorApproval || isPlannerProviderBudgetActivation || isPlannerTimeBudgetActivation || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isDispatchSkippedRecovery) {
    if (isProtectedCutoverActivation || isProtectedCutoverRefresh || isProtectedCutoverRecovery || isProtectedCutoverFinal || isSuccessorCutoverActivation || isPlannerOutputShapeActivation || isPlannerOutputShapeBranchCorrection || isPlannerProviderBudgetActivation || isPlannerTimeBudgetActivation || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isDispatchSkippedRecovery) {
    ...
    if (isProtectedCutover || isSuccessorReleaseApproval || isPlannerOutputShapeApproval || isPlannerPhaseCandidateRefresh || isPlannerTimeBudgetApproval || isPlannerProviderBudgetSuccessorApproval) {
