...
export function validate() {
  ...
  if (isProtectedCutover || isProtectedCutoverActivation || isProtectedCutoverRefresh || isProtectedCutoverRecovery || isProtectedCutoverFinal || isSuccessorReleaseApproval || isSuccessorCutoverActivation || isPlannerTimeBudgetApproval || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isDispatchSkippedRecovery) {
    if (isProtectedCutoverActivation || isProtectedCutoverRefresh || isProtectedCutoverRecovery || isProtectedCutoverFinal || isSuccessorCutoverActivation || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isDispatchSkippedRecovery) {
      ...
      assert.equal(protectedCutover.workflow.allowControllerActivation, isSuccessorCutoverActivation || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isDispatchSkippedRecovery || isProtectedCutoverLaneRefresh || isProtectedCutoverPmIdentityRefresh ? false : true);
    ...
    if (isProtectedCutover || isSuccessorReleaseApproval || isPlannerTimeBudgetApproval) {
