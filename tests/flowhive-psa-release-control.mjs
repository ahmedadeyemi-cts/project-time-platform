...
export function verifyFiles(changed, manifest, mode = 'initial', context = null) {
  ...
  const scopedExpected = mode === 'protected-cutover-lane-refresh' ? protectedCutoverLaneRefreshFiles : expected;
