...
export function validate() {
  ...
  if (isProtectedCutover || isProtectedCutoverActivation || isProtectedCutoverRefresh || isProtectedCutoverRecovery || isProtectedCutoverFinal || isSuccessorReleaseApproval || isSuccessorCutoverActivation || isPlannerOutputShapeApproval || isPlannerOutputShapeActivation || isPlannerOutputShapeBranchCorrection || isPlannerPhaseCandidateRefresh || isLivePlannerCandidateRefresh || isPlannerLatencyCandidateRefresh || isPlannerContextBudgetCandidateRefresh || isPlannerSingleBatchCandidateRefresh || isPlannerCompactBatchCandidateRefresh || isPlannerCompactBatchActivation || isPlannerCompactBatchAdmissionAncestryFix || isPlannerSingleBatchActivation || isPlannerContextBudgetActivation || isPlannerLatencyActivation || isLivePlannerActivation || isPlannerTimeBudgetApproval || isPlannerProviderBudgetSuccessorApproval || isPlannerProviderBudgetActivation || isPlannerTimeBudgetActivation || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isPlannerOutputBudgetCandidateRefresh || isPlannerOutputBudgetFinalActivation || isDispatchSkippedRecovery) {
    if (isProtectedCutoverActivation || isProtectedCutoverRefresh || isProtectedCutoverRecovery || isProtectedCutoverFinal || isSuccessorCutoverActivation || isPlannerOutputShapeActivation || isPlannerOutputShapeBranchCorrection || isPlannerCompactBatchActivation || isPlannerCompactBatchAdmissionAncestryFix || isPlannerSingleBatchActivation || isPlannerContextBudgetActivation || isPlannerLatencyActivation || isLivePlannerActivation || isPlannerProviderBudgetActivation || isPlannerTimeBudgetActivation || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isPlannerOutputBudgetFinalActivation || isDispatchSkippedRecovery) {
      ...
      assert.equal(protectedCutover.workflow.allowControllerActivation, isProtectedCutoverActivation || isPlannerOutputShapeActivation || isPlannerOutputShapeBranchCorrection || isPlannerCompactBatchActivation || isPlannerCompactBatchAdmissionAncestryFix || isPlannerSingleBatchActivation || isPlannerContextBudgetActivation || isPlannerLatencyActivation || isLivePlannerActivation || isPlannerProviderBudgetActivation || isPlannerTimeBudgetActivation || isSuccessorCutoverActivation || isPlannerOutputBudgetActivation || isPlannerOutputBudgetActivationRefresh || isPlannerOutputBudgetFinalActivation || isDispatchSkippedRecovery || isProtectedCutoverLaneRefresh || isProtectedCutoverPmIdentityRefresh ? false : true);
