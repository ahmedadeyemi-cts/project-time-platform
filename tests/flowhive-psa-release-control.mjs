...
export function validate() {
  ...
  if (!isPlannerNativeTestApprovalRenewal && !isPlannerLiveRepairCandidateRefresh && !isPlannerLiveRepairFinalRefresh && !isPlannerProviderContractRefresh && !isPlannerLiveProviderOutputRefresh && !isInstalledVerifierMainPath && !isInstalledVerifierStepNames) verifyFiles(changed, manifest,
