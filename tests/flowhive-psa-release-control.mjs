...
export function verifyFiles(changed, manifest, mode = 'initial', context = null) {
  ...
  const effectiveScopedExpected = mode === 'trigger-coverage' ? triggerCoverageFiles : mode === 'planner-provider-deadline-retry' ? plannerProviderDeadlineRetryFiles : mode === 'planner-provider-deadline-candidate-refresh' ? plannerProviderDeadlineCandidateRefreshFiles : mode === 'planner-control-candidate-approval' ? plannerControlCandidateApprovalFiles : mode === 'planner-control-candidate-base-correction' ? plannerControlCandidateBaseCorrectionFiles : mode === 'planner-native-test-approval-renewal' ? plannerNativeTestApprovalRenewalFiles : mode === 'planner-live-repair-candidate-refresh' ? plannerLiveRepairCandidateRefreshFiles : mode === 'planner-live-repair-final-refresh' ? plannerLiveRepairFinalRefreshFiles : mode === 'planner-provider-contract-refresh' ? plannerProviderContractRefreshFiles : mode === 'planner-live-provider-output-refresh' ? plannerLiveProviderOutputRefreshFiles : mode === 'installed-verifier-main-path' ? installedVerifierMainPathFiles : mode === 'installed-verifier-step-names' ? installedVerifierStepNamesFiles : mode === 'module025-sow-role-candidate-refresh' ? module025SowRoleCandidateRefreshFiles : mode === 'module025-sow-role-candidate-refresh-final' ? module025SowRoleCandidateRefreshFinalFiles : mode === 'module025-sow-role-candidate-refresh-1009' ? module025SowRoleCandidateRefresh1009Files : mode === 'module025-sow-role-candidate-refresh-1014' ? module025SowRoleCandidateRefresh1014Files : mode === 'module025-sow-role-admission-scope' ? module025SowRoleAdmissionScopeFiles : mode === 'module025-sow-role-native-activation' ? module025SowRoleNativeActivationFiles : mode === 'module025-sow-role-native-active' ? module025SowRoleNativeActiveFiles : mode === 'module025-sow-role-live-acceptance' ? module025SowRoleLiveAcceptanceFiles : mode === 'module025-sow-role-live-repair' ? module025SowRoleLiveRepairFiles : mode === 'admission-manifest-order' ? admissionManifestOrderFiles : scopedExpected;
