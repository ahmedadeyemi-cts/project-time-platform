...
grep -Fq 'Apply and verify governed migrations through Module 025 project-name migration 109 inside Test private network' "$DEPLOYMENT"
grep -Fq '109_module025_project_name' "$DEPLOYMENT"
