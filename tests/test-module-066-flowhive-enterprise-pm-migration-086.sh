...
grep -Fq "FlowHiveWriteOperation.Meetings" "$ROOT/src/backend/ProjectTime.Api/Modules/ProjectFlowHivePsaModule.cs"
grep -Fq "FlowHiveWriteOperation.TaskReminders" "$ROOT/src/backend/ProjectTime.Api/Modules/ProjectFlowHivePsaModule.cs"
grep -Fq "MANAGE_FLOWHIVE_MEETINGS_066" "$ROOT/src/backend/ProjectTime.Api/Modules/ProjectFlowHivePsaModule.cs"
grep -Fq "MANAGE_FLOWHIVE_TASK_REMINDERS_066" "$ROOT/src/backend/ProjectTime.Api/Modules/ProjectFlowHivePsaModule.cs"
grep -Fq "HasFlowHivePermissionAsync" "$ROOT/src/backend/ProjectTime.Api/Modules/ProjectFlowHivePsaModule.cs"
grep -Fq "actual == effective" "$ROOT/src/backend/ProjectTime.Api/Modules/ProjectFlowHivePsaModule.cs"
