...
await Sql("""
    ...
    CREATE TABLE project_forge_plans(plan_id UUID PRIMARY KEY,project_id UUID,plan_name TEXT,plan_status TEXT,source_kind TEXT,revision_number INTEGER,adopted_by_user_id UUID NULL,adopted_at TIMESTAMPTZ NULL,review_notes TEXT NOT NULL DEFAULT '',updated_by_user_id UUID);
