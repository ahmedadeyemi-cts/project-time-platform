...
const module025RetainedRegisterMode = branchName === 'fix/module025-retained-register-verification-20260919';
...
const privateGenerationMode = branchName === 'fix/module025-private-generation-recovery';
if (privateGenerationMode) childProcess.execFileSync('python3', ['tests/module025-private-generation-scope.py'], {stdio:'inherit'});
const connectWiseSellMode = branchName === 'fix/connectwise-sell-module026';
if (connectWiseSellMode) childProcess.execFileSync('python3', ['tests/connectwise-sell-release-scope.py'], {stdio:'inherit'});
const flowHiveSequentialMode = branchName === 'feature/flowhive-sequential-wbs-20260920';
const flowHivePlanDepthMode = branchName === 'fix/flowhive-sow-plan-depth-20260925';
const flowHiveEnterpriseUsabilityRoutingMode = branchName === 'fix/flowhive-enterprise-usability-routing-20260926';
const flowHiveWholeWbsFailSafeMode = branchName === 'fix/flowhive-source-grounded-failsafe-20260926';
if (flowHiveWholeWbsFailSafeMode) childProcess.execFileSync('python3', ['tests/flowhive-whole-wbs-failsafe-scope.py'], {stdio:'inherit'});
if (flowHiveEnterpriseUsabilityRoutingMode) childProcess.execFileSync('python3', ['tests/flowhive-enterprise-usability-routing-scope.py'], {stdio:'inherit'});
if (flowHivePlanDepthMode) childProcess.execFileSync('python3', ['tests/flowhive-sow-plan-depth-scope.py'], {stdio:'inherit'});
