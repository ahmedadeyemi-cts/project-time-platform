...
const base = '382fa4a8182f24dacd0fe15a7bd1e465c8b0dccc';
const expected = [
  ...
  "tests/module025-register-report-contract-scope.mjs",
  "tests/module025-sow-register-browser.py"
];
const registrations = {
  ".github/workflows/module025-governed-protected-test-release-manual.yml": "          if [[ \"$HEAD_BRANCH\" == 'fix/module025-register-report-contract-20260918' ]]; then\n            node tests/module025-register-report-contract-scope.mjs\n            node tests/validate-systemwide-image-build-controller.mjs\n            exit 0\n          fi\n",
  ".github/workflows/flowhive-psa-release-control-ci.yml": "          elif [[ \"$GITHUB_HEAD_REF\" == 'fix/module025-register-report-contract-20260918' ]]; then\n            node tests/module025-register-report-contract-scope.mjs\n",
  "scripts/release-test/validate-protected-test-controller-branches.sh": "elif [[ \"$HEAD_BRANCH\" == 'fix/module025-register-report-contract-20260918' ]]; then\n  node tests/module025-register-report-contract-scope.mjs\n  node tests/validate-systemwide-image-build-controller.mjs\n"
};
const replacements = {
  "const module025PhaseProviderRecovery =": "const module025RegisterReport = process.env.GITHUB_HEAD_REF === 'fix/module025-register-report-contract-20260918';\nconst module025PhaseProviderRecovery =",
  "  || module025PhaseProviderRecovery ||": "  || module025RegisterReport || module025PhaseProviderRecovery ||",
  "const module025VerifierBase = module025PhaseProviderRecovery ?": "const module025VerifierBase = module025RegisterReport ? '382fa4a8182f24dacd0fe15a7bd1e465c8b0dccc' : module025PhaseProviderRecovery ?"
};
...
console.log('MODULE025_REGISTER_REPORT_SCOPE=PASS exact_files=8 application=unchanged deployment_authority=unchanged');
