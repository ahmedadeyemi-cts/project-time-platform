...
const base = '3b7185292c013cd032b87ce6764ea238813e9e7a';
const expected = [
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  'docs/releases/2026-09-17-module025-browser-verifier.md',
  ...
  'tests/module025-browser-verifier-scope.mjs',
  'tests/validate-celar-ai-pr630-consolidated.mjs'
].sort();

export function verifyModule025BrowserVerifierScope() {
  ...
  console.log('MODULE025_BROWSER_VERIFIER_SCOPE=PASS deployment_authority=unchanged celar_runtime=unchanged');
}
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) verifyModule025BrowserVerifierScope();
