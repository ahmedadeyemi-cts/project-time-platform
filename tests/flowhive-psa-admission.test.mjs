...
test('workflow-dispatch evidence is candidate-bound and cannot substitute another run', () => {
  ...
  assert.equal(workflowDispatchChecks.length, plannerLiveCelarBudgetApproval || plannerLiveCelarCompactPromptRepair || module025ManualTriggerExactCandidate || plannerCelarRequiredCheckRefresh ? 2 : plannerCelarApprovalRefresh || plannerCandidateApprovalRefresh ? 2 : 3);
