...
requireText(currentTestController, "contains(github.event.head_commit.message, 'celar-hostname-runtime-20260905')", 'one-time user-authorized hostname recovery on merge')
