...
requireText(services, 'ResolveConnectAddressesAsync', 'connect-time validated DNS addresses')
...
rejectText(currentTestController, "contains(github.event.head_commit.message, 'celar-hostname-runtime-20260905')", 'retired merge-trigger recovery path')
requireText(currentTestController, "github.event_name == 'workflow_dispatch'", 'workflow-dispatch-only recovery')
