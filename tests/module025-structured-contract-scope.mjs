...
const base = 'f30b4e3a8cc7ba8daba4cad001e5dca84f7140f6';
const expected = [
  '.github/workflows/flowhive-psa-release-control-ci.yml',
  'docs/releases/2026-09-17-module025-structured-contract.md',
  ...
  'tests/module025-structured-contract-scope.mjs',
  'tests/validate-celar-ai-pr630-consolidated.mjs'
].sort();

export function verifyModule025StructuredContractScope() {
  ...
  console.log('MODULE025_STRUCTURED_CONTRACT_SCOPE=PASS deployment_authority=unchanged celar_runtime=unchanged');
}
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) verifyModule025StructuredContractScope();
