...
assert.match(executionPolicy, /OverallBudget = TimeSpan.FromMinutes\(40\)/);
assert.match(executionPolicy, /InferenceBudget = TimeSpan.FromMinutes\(38\)/);
...
assert.match(observation, /maximumObservationMs = 42 \* 60 \* 1000/);
