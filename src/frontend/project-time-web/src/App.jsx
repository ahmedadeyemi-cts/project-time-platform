...
const roleWorkspaceModules = sortProjectPulseModules([
  ...
  },
  {
    ...
    description: 'Create a new project from GSD or ConnectWise SELL. ConnectWise SELL supplies the authoritative project name and Actual Rate / Pricing / Rate Review.',
  ...
  },
  {
    ...
    navLabel: "MODULE 026",
    description: "Connect ConnectWise SELL, Salesforce, Certinia, ServiceNow, and manually registered CRM/ERP platforms and review sanitized availability status.",
  ...
  },
  {
    ...
    permissions: ["VIEW_PROJECT_INTAKE", "MANAGE_PROJECT_INTAKE", "MANAGE_PROJECT_DOCUMENTS", "VIEW_PROJECT_WORKSPACE", "VIEW_RESOURCE_SCHEDULING", "MANAGE_RESOURCE_SCHEDULING", "SYSTEM_ADMINISTRATION", "MANAGE_ALL"],
    roleCodes: ["SALES", "INSIDE_SALES", "ACCOUNT_EXECUTIVE", "ACCOUNT_EXECUTIVES", "SOLUTION_ARCHITECT", "SA", "SAA", "PROJECT_TEAM_COORDINATOR", "PROJECT_COORDINATOR", "PROJECT_MANAGER", "PROJECT_MANAGEMENT", "ENGINEER", "ENGINEERING"],
  },
  {
    route: "ai-time-entry",
    href: "#ai-time-entry",
...
function getInstalledModuleDescription(module) {
  ...
  const descriptions = {
    ...
    'create-work-register': 'Creates Work Register records from GSD or ConnectWise SELL; ConnectWise SELL is authoritative for project name and Actual Rate / Pricing / Rate Review.',
...
{(activeRoute === 'audit-history' && (hasPermission('VIEW_AUDIT_TRAIL') || hasPermission('SYSTEM_ADMINISTRATION') || hasPermission('MANAGE_ALL'))) ? (
      ...
      {![
        ...
        'full-future-loop',
        /* MODULE_084_CELAR_RUNTIME_VERSION_FALLBACK_EXCLUSION_START */
