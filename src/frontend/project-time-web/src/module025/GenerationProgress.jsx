...
export default function GenerationProgress({ monitor, now, canGenerate, dirty, onResume }) {
  ...
  const provider = { celar_ai: 'Celar AI', deepseek_v4: 'DeepSeek', claude: 'Claude', openai: 'OpenAI', gemini: 'Gemini', copilot: 'Microsoft Copilot' }[payload?.currentProvider];
  ...
  return <section className="m025-generation-progress" aria-label="AI generation progress" aria-busy={active && !error}>
    ...
    <p>Enter the project scope once in Service Overview. AI uses it to generate Plan, Design, Implement, Validate and Release in order, then prepares the SOW and detailed GSD for your review.</p>
