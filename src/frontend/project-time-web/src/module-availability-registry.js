...
export const PROJECTPULSE_MODULES = Object.freeze([
  ...
  Object.freeze({ moduleNumber: '001B', route: 'time-reallocation', displayName: 'Time Reallocation & Corrections', group: 'Time Management', description: 'PTC and Super Administrator-only administrative reallocation of time across project tasks, service requests, and non-project activities without unsubmit, Draft transition, worker resubmission, Manager approval, or Project Manager approval.' }),
  ...
  Object.freeze({ moduleNumber: '006', route: 'toyota-hyundai-pipelines', displayName: 'Toyota & Hyundai Pipelines', group: 'Sales & Opportunities', description: 'Governed Toyota and Hyundai project pipeline with active and archived delivery context, ownership, engineering assignments, ConnectWise SELL references, tasks, documents, financial context, and lifecycle evidence.' }),
  ...
  Object.freeze({ moduleNumber: '033', route: 'project-forge', displayName: 'Project Forge', group: 'Project Delivery', description: 'Live project planning across all fifteen Ultimate Project Manager workbook views, with governed estimates, private document-grounded AI, and Module 065 notifications.' }),
  ...
  Object.freeze({ moduleNumber: '055D', route: 'create-work-register', displayName: 'Create New Project', group: 'Project Operations', description: 'Authoritative project-creation workflow using GSD or ConnectWise SELL source information.' }),
