...
const tabs = [['overview', 'Project context'], ['completion', 'Delivery & closeout'], ['team', 'Team & hours'], ['financials', 'Financials'], ['expenses', 'Expenses'], ['documents', 'Documents']];
