...
if (cssImportIndex < 0 || contrastGuardIndex < 0 || cssImportIndex > contrastGuardIndex) {
  fail('contrast_guard_must_remain_last');
}

console.log('ENTERPRISE_UI_POLISH=PASS appearance=renamed logos=verified-vectors celar=enterprise more=click-away route-flow=compact react-ownership=preserved');
