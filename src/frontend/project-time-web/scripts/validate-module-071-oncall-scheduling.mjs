...
check('PUBLIC_APIS', backend.includes('/api/public/v1/oncall/current') && backend.includes('/api/public/v1/oncall/schedule') && frontend.includes('https://oncall.onenecklab.com/') && frontend.includes('OnCall Pay Form'), 'public schedule and exact pay-form action preserved');
