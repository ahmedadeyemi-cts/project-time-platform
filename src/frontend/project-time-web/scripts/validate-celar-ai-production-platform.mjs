...
assert('FLOWHIVE_UI', flowHive.includes("'/api/project-flowhive/ai/production-generate'") && flowHive.includes('Generate detailed Celar AI plan') && flowHive.includes('celar-flowhive-production-result'), 'FlowHive studio performs real detailed generation');
