...
check('MODULE_998_VERIFICATION_PRESERVES_EXECUTION_EVIDENCE',backend.includes('execution = ReadJsonEvidence(executionResultJson)')&&backend.includes('verification = verificationResult'));
