...
assert(
  ...
  routing.includes('public static class CelarAiExternalCapsuleCatalog')
    ...
    && routing.includes('var externalPrompt = fixedCapsule.Capsule')
    && routing.includes('Content: execution.ExternalProblemStatement')
    && routing.includes('UserPrompt = fixedCapsule.Capsule')
