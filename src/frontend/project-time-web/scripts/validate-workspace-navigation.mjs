...
for (const marker of ['WorkspaceQuickLauncher', 'Workspace Directory', 'Search workspaces', 'View all workspaces', 'Recently used', 'Favorites', 'Browse by category', 'Toyota', 'Hyundai', 'Turion', 'authorizedModulesFromNavigationState', '__projectPulseEffectiveNavigation', 'View-As active', 'Retry verification', 'workspace-directory']) {
...
console.log('PR698_WORKSPACE_NAVIGATION=PASS authority=shared-rbac availability=fail-closed viewAs=effective favorites=user-specific');
