...
public static class CustomerDirectorySellSyncModule
{
    ...
    private const string ProviderKey = ConnectWiseSellApi.ProviderKey;
    private const string SourceSystem = "CONNECTWISE_SELL";
    private const string MigrationId = "049_module_021_sell_customer_sync";
    private static readonly Uri SellBaseUri = new(ConnectWiseSellApi.BaseUrl);
    ...
    private static async Task<IResult> GetStatusAsync(HttpContext context)
    {
        ...
        return Results.Ok(new
        {
            ...
            provider = provider is null
                ...
                {
                    configured = false,
                    name = ConnectWiseSellApi.DisplayName,
            ...
            customerSyncSupported = false,
            customerSyncMessage = ConnectWiseSellApi.CustomerSyncMessage,
            linkedCustomers,
            lastRun,
    ...
    private static IResult CustomerAdapterRequired() => Results.Json(new
    {
        ...
        message = ConnectWiseSellApi.CustomerSyncMessage,
        customerSyncSupported = false
