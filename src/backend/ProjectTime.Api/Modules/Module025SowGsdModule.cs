...
public static class Module025SowGsdModule
{
    ...
    private static async Task<IResult> GenerateAsync(Guid engagementId, HttpContext context, CancellationToken cancellationToken)
    {
        ...
        {
            context.RequestServices.GetRequiredService<ILoggerFactory>().CreateLogger("Module025SowGsd").LogWarning(exception, "Module 025 detailed SOW/GSD generation failed without logging customer or Service Overview content.");
            return Results.Json(new { status = "module025_ai_temporarily_unavailable", message = "The governed Celar AI route did not complete. The saved SOW/GSD draft was not changed." }, statusCode: StatusCodes.Status503ServiceUnavailable);
        }
        ...
        var sowSections = JsonSerializer.SerializeToElement(new
        {
        ...
        var aiMetadata = JsonSerializer.SerializeToElement(new
        {
