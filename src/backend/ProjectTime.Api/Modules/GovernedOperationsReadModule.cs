...
internal static class GovernedOperationsReadModule
{
    ...
    internal static object OperationalSurface(string module, string version, string surface)
    {
        ...
        {
            ("077", "overview") => ("Release readiness", "Governed releases, environments, gates, evidence, and rollback.", "Prepare release", new object[] { new { name = "Current Pulse deployment", status = "Deployed", authority = "GitHub Actions and Azure" } }),
            ...
            ("078", "overview") => ("Application health", "Pulse service, dependency, signal, and SLO view.", "Add SLO", new object[] { new { service = "Pulse API", observation = "This request succeeded", status = "Reachable" } }),
            ("078", "services") => ("Service catalog", "Owned services and dependency relationships.", "Register service", new object[] { new { service = "Pulse API", owner = "Platform Operations", tier = "Critical" }, new { service = "Pulse Web", owner = "Platform Operations", tier = "Critical" } }),
            ...
            ("079", "overview") => ("Governance posture", "Data ownership, classification, lineage, retention, holds, and privacy.", "Register domain", new object[] { new { domain = "Pulse operational data", owner = "Platform Administration", status = "Governed" } }),
