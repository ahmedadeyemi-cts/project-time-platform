...
public static class ModuleAvailabilityModule
{
    ...
    private static readonly IReadOnlyDictionary<string, ModuleDefinition> Definitions =
        new Dictionary<string, ModuleDefinition>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["005"] = Module("005", "project-allocation-info", "Project Expense Upload", "Project Management"),
            ["006"] = Module("006", "toyota-hyundai-pipelines", "Toyota & Hyundai Pipelines", "Sales & Opportunities"),
            ...
            ["010"] = Module("010", "azure-admin", "Azure / Entra Directory Users", "Administration"),
            ["011"] = Module("011", "work-task-builder", "Celar AI", "AI & Automation"),
            ["012"] = Module("012", "role-admin", "Role Administration", "Administration"),
            ["013"] = Module("013", "service-control", "System Health & API Diagnostics", "Platform Operations"),
            ...
            ["016"] = Module("016", "backup-retention", "Operational Evidence & Backup Retention", "Platform Operations"),
            ...
            ["019"] = Module("019", "project-workspace", "Project Engineering Workspace", "Project Delivery"),
            ["020"] = Module("020", "project-intake", "Project Intake & Resource Handoff", "Project Delivery"),
            ...
            ["030"] = Module("030", "reporting", "Analytics Center", "Reports & Workflow"),
            ["031"] = Module("031", "financial-operations-workbench", "Financial Operations Workbench", "Reports & Workflow"),
            ["032"] = Module("032", "notification-delivery-monitor", "Notification Delivery Monitor", "Reports & Workflow"),
            ...
            ["038"] = Module("038", "certify-integration", "Certify Connection & Sync Center", "Integrations"),
            ...
            ["065"] = Module("065", "entra-secret-administration", "Microsoft Integration Connection", "Integrations"),
            ...
            ["068"] = Module("068", "system-architecture", "Provider-Neutral System Architecture", "Platform Operations"),
