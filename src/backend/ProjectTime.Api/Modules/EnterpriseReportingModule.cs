...
public static class EnterpriseReportingModule
{
    ...
    private static async Task<IResult> GetCatalogAsync(HttpContext context)
    {
        ...
        {
            module = "030",
            moduleName = "Enterprise Reporting Center",
    ...
    {
        module = "030",
        status = "migration_054_required",
        migration = EnterpriseReportingRepository.MigrationId,
        message = "The Enterprise Reporting source is installed, but immutable run history and saved-view persistence require migration 054. Preview remains available."
