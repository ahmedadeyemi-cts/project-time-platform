...
public sealed class PulseAiQuestionPlanner
{
    ...
    [
        new(
            ...
            Routes: ["/api/pulse-ai/v1/help-search/plan", "#user-guide", "#defect-tracker"],
        ...
        new(
            ...
            Routes: ["/api/pulse-ai/v1/timesheet/context-preview", "/api/pulse-ai/v1/flowhive/context-preview"],
        ...
        bool forceInsight)
    {
        ...
        var directAnswer = FindKnowledgeAnswer(normalized);
