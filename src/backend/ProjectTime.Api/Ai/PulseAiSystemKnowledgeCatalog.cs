...
public static class PulseAiSystemKnowledgeCatalog
{
    ...
    [
        ...
        Tool(
            ...
            "Celar AI Private RAG Readiness",
            "011",
            "Celar AI",
        ...
        Tool(
            ...
            "Celar AI Document Runtime Readiness",
            "011",
            "Celar AI",
        ...
        IReadOnlyList<PulseAiSystemToolResult> tools)
    {
        ...
        var gaps = new List<string>
        {
            ...
            "Identify which existing module is the source of truth and avoid duplicating calculations or operational state in Celar AI.",
        ...
        return new PulseAiEnhancementBlueprint(
            ...
            [
                "Experience layer: add the feature to the owning application module and expose Celar AI as an assistive, explainable interface rather than the system of record.",
            ...
            [
                ...
                "Owning-module calculations and state match Celar AI explanations exactly.",
    ...
    [
        ...
        ("019", "Project Engineering Workspace", ["/api/project-workspace"]),
        ...
        ("024", "Sales Intake", ["/api/sales-intake"]),
        ("025", "SOW Generator", ["/api/sow"]),
        ("026", "CRM / ERP Integration Center", ["/api/integrations/026"]),
        ("027", "Signed Handoff", ["/api/signed-handoff", "/api/resource-assignment-handoff"]),
        ("028", "AI Time Entry", ["/api/ai-time-entry"]),
        ("029", "UAT Validation", ["/api/uat"]),
        ("030", "Analytics Center", ["/api/report", "/api/project-financials", "/api/analytics"]),
        ("031", "Financial Operations Workbench", ["/api/financial-operations"]),
        ("032", "Notification Delivery Monitor", ["/api/notification-delivery"]),
        ("033", "Project Forge", ["/api/project-forge"]),
        ("036", "Sales Insights Dashboard", ["/api/sales-insights"]),
        ("037", "Roles & Permissions Matrix", ["/api/roles-permissions"]),
        ("038", "Certify Connection & Sync Center", ["/api/certify"]),
        ...
        ("063", "Opportunities", ["/api/opportunities"]),
        ...
        ("067", "Global Mail Configuration Center", ["/api/global-mail"]),
        ("068", "Provider-Neutral System Architecture", ["/api/platform-operations/architecture", "/api/system-architecture"]),
        ("069", "Qualifications & Certification Matrix", ["/api/qualifications"]),
        ...
        ("080", "Customer Delivery & Acceptance Portal", ["/api/customer-delivery"]),
        ("997", "Security Operations, Threat Intelligence & Response Center", ["/api/security-operations"]),
        ("998", "System Diagnostic & Controlled Remediation Center", ["/api/system-diagnostics"]),
        ("999", "System User Guide", ["/api/user-guide"])
    ];
}
